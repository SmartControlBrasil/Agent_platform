...
class CRMDispatchServiceTests(TestCase):
    ...
    def test_build_payload(self):
        ...
        self.assertIn("NOVO ATENDIMENTO — LÍVIA", payload.notes)
        self.assertIn("RESUMO DO ATENDIMENTO", payload.notes)
    ...
    def test_dispatch_success_marks_sent_to_crm(self):
        ...
        self.assertIn("NOVO ATENDIMENTO — LÍVIA", sent_payload.notes)
